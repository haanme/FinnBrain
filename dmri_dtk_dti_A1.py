...
subject_list = ['subj1', 'subj2' 'subj3' 'subj4']
...
datasource.inputs.base_directory = os.path.abspath('/Users/eija/Documents/Finnbrain/DTIprep_results_4cases_feb')
...
dwieddy = pe.Workflow(name="dwieddy")
dwieddy.base_dir = os.path.abspath('finnbrain_pipelines')
dwieddy.connect([
...
if __name__ == '__main__':
    #    dwieddy.run()
    dwieddy.write_graph(graph2use='hierarchical')
