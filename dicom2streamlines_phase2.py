...
if __name__ == "__main__":
    ...
    # Run DTIprep
    qcfile = (experiment_dir + '/' + args.subject + '/' + args.subject + '_motioncorrected_QCed.nrrd')

    # Convrt for dtifit
    dwifile, bval_file, bvec_file = conv.nrrd2nii(qcfile, args.subject)
    no_bvalues = len(np.genfromtxt(bval_file))
    ...
    copy_to_results(bval_file, 'bvals', args.subject)
    copy_to_results(bvec_file, 'bvecs', args.subject)
